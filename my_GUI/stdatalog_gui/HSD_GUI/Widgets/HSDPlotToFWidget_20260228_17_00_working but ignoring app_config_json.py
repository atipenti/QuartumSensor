...
class HSDPlotToFWidget(PlotWidget):    
    def __init__(self, controller, comp_name, comp_display_name, plot_params, p_id=0, parent=None):
        ...
        # 2. Load Configuration from \Dev\my_GUI\app_config.json
        # Path logic: Go up 4 levels from this file's location
        try:
            ...
            if os.path.exists(config_path):
                ...
                self.app_cfg = {"network_config": {"sensors": {"VL53L8_ToF": {"port": 12345}}}}
