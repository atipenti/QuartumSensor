...
info_img_path_valid = resource_filename('stdatalog_gui.UI.icons', 'outline_info_white_18dp.png')
info_img_path_invalid = resource_filename('stdatalog_gui.UI.icons', 'info_18dp_FF0000.svg')
